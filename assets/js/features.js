    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">CITL</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">CITL</span> <span class="clr-green md">Canteen</span></div>
                ...
                <main class="grid grid-3">
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-22-24309491</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>ctil.ho@adityabirla.com</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Century Bhavan, Dr. Annie Besant Road, Worli, Mumbai 400030, Maharashtra,
India</p></li>
